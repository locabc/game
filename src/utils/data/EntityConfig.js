...
const entityConfig = {
    ...
    'GoldenHook': {
        ...
        effect: 'speed_boost', duration: 30000, spawnChance: 0.1
    },
    
    'TimeCrystal': {
        type: 'SpecialEffect', mass: 3.6, bonus: 200, bonusType: 'High', 
        effect: 'time_bonus', timeAdd: 10, spawnChance: 0.1
    },
    
    'MagnetStone': {
        type: 'SpecialEffect', mass: 3.6, bonus: 150, bonusType: 'High',
        effect: 'magnet_pull', radius: 80, spawnChance: 0.1
    },
    
    'LuckyStar': {
        type: 'SpecialEffect', mass: 3.6, bonus: 300, bonusType: 'High',
        effect: 'lucky_streak', streakCount: 3, spawnChance: 0.1
    },
